...
**Gulp** is a Yelp search app using the [Yelp API](http://www.yelp.com/developers/documentation/v2/search_api).
...
<img src='https://i.imgur.com/tYbiOJe.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
